                            ...
                            if(result[0].verticalscount > 0){
                                ...
                                if(result[0].active == 'Y'){
                                    if(Password.verify( req.body.password , result[0].password)){
                                        var newtoken = jwt.sign({ "email": result[0].email, "user_id": result[0].user_id ,"office_id" : result[0].office_id , "region_id" : result[0].region_id , "division_id" : result[0].division_id, "dealer_id" : result[0].dealer_id , "user_type" : result[0].user_type ,
    ...
    getNearestLocations(req, res, next){
        ...
        MongoClient.connect(mongourl,{ useNewUrlParser: true }, function(err, client) {
            ...
            collection.find(
                ...
                { projection: {  type : 1, geometry : 1 , 'properties.consumer_id':1,'properties.Latitude': 1, 'properties.icon':1,'properties.status':1, 'properties.Longitude':1, dealer : 1,
            ...
            if (req.decoded.user_id) {
                ...
                .then((result) => {
                    ...
                    if(result.length > 0 ){
                        ...
                        .then((respo) => {
                            let insArray2 = {user_id : req.decoded.user_id ,residential_id : req.body.residential_id,latitude : req.body.latitude,longitude : req.body.longitude,residential_customer_id : req.body.residential_customer_id,dealer_id : req.decoded.dealer_id,created_at : moment().format("YYYY-MM-DD H:mm:ss")
                            };
                        ...
                        .then((respo) => {
                            let insArray1 = {user_id: req.decoded.user_id ,residential_id : req.body.residential_id,latitude : req.body.latitude,longitude : req.body.longitude,residential_customer_id : req.body.residential_customer_id,dealer_id : req.decoded.dealer_id,created_at: moment().format("YYYY-MM-DD H:mm:ss")
                            };
