...
let handler = {
    ...
    checkMultiple(req, res, next) {
        ...
        //     } else if (req.body.location == 'US-CO') {
        //         tableName = 'consumer_data_co';
        //     } else if (req.body.location == 'US-UT') {
        //         tableName = 'consumer_data_ut';
        //     } else if (req.body.location == 'US-ID') {
        //         tableName = 'consumer_data_id';
        //     } else if (req.body.location == 'US-OK') {
        //         tableName = 'consumer_data_ok';
        //     } else if (req.body.location == 'US-FL') {
        //         tableName = 'consumer_data_fl';
        //     } else if (req.body.location == 'US-NC') {
        //         tableName = 'consumer_data_nc';
        //     } else if (req.body.location == 'US-SC') {
        //         tableName = 'consumer_data_sc';
        //     } else {
        //         tableName = 'consumer_data_nj';
        //     }
        // } else {
    ...
    updateToMongo(req, res, next) {
        ...
        if (req.body.location != undefined && req.body.location != '') {
            if (req.body.location == 'US-NJ') {
                ...
                tableName = 'residential_data_co';
            } else if (req.body.location == 'US-UT') {
                tableName = 'residential_data_ut';
            } else if (req.body.location == 'US-ID') {
                tableName = 'residential_data_id';
            } else if (req.body.location == 'US-OK') {
                tableName = 'residential_data_ok';
            } else if (req.body.location == 'US-FL') {
                tableName = 'residential_data_fl';
            } else if (req.body.location == 'US-NC') {
                tableName = 'residential_data_nc';
            } else if (req.body.location == 'US-SC') {
                tableName = 'residential_data_sc';
            } else {
                tableName = 'residential_data_nj';
            }
        } else {
